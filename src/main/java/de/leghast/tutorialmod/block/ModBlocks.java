...
import de.leghast.tutorialmod.block.custom.SpeedyBlock;
...
public class ModBlocks {
    ...
    public static final Block SPEEDY_BLOCK = registerBlock("speedy_block",
            new SpeedyBlock(FabricBlockSettings.of(Material.STONE).strength(4f).requiresTool()), ModItemGroup.MYTHRIL);
